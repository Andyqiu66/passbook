...
import com.njupt.passbook.service.IGainPassTemplateService;
...
@Slf4j
@Service
public class GainPassTemplateSeviceImpl implements IGainPassTemplateService {
    ...
    @Autowired
    public GainPassTemplateSeviceImpl(HbaseTemplate hbaseTemplate,
    ...
    private boolean addPassForUser(GainPassTemplateRequest request,
        ...
        byte[] USER_ID=Constants.PassTable.USED_ID.getBytes();
